...
// Student class a class which is taking name and age property from its parent so we do not need to declear these properties here.
...
class StudentMarks : public Student {
    ...
    void setAge (double a, string  n, double m) {
        age = a;
        name= n;
        marks=m;
    }
...
int main(){
    StudentMarks stu1;
    stu1.setAge(2, "Muhammad Haroon Talib", 450);
    stu1.rollno= 2;
